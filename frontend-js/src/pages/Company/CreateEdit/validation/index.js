...
export default function validation () {
  const schema = Yup.object().shape({
    ...
    email: Yup.string()
      ...
      .required('O e-mail é obrigatório').max(100, 'Máximo 100 caracteres'),
    ...
    city: Yup.string().required('A cidade é obrigatória').max(100, 'Máximo 100 caracteres'),
    bairro: Yup.string().required('O bairro é obrigatório').max(100, 'Máximo 100 caracteres'),
